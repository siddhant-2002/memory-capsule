  ...
  return (
    <div className='w-[100%] h-[100%] overflow-x-hidden overflow-scroll p-10'>
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full md:w-1/2 p-4">
            <h2 className="text-2xl font-bold text-gray-800">About Memory Capsule</h2>
            <p className="mt-2 text-gray-600">Memory Capsule is a unique platform dedicated to preserving your most cherished memories. Whether it's photos, videos, or written stories, our service ensures that your memories are stored securely and can be revisited anytime, anywhere.</p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full md:w-1/2 p-4 order-2 md:order-1">
            ...
            <p className="mt-2 text-gray-600">We offer a variety of services to help you capture, preserve, and share your memories. From digital time capsules to personalized memory books, our platform is designed to cater to all your memory preservation needs.</p>
          </div>
        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full md:w-1/2 p-4 order-2 md:order-1">
            ...
            <p className="mt-2 text-gray-600">We're here to help you preserve your memories. If you have any questions, suggestions, or need assistance, please don't hesitate to reach out to us.</p>
